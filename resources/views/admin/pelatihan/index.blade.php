                ...
                <table class='table table-striped' id="table1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <a href="{{Route('userAdmin.pelatihan.show','1')}}" class="btn btn-sm icon icon-left btn-info mb-1"><i data-feather="edit"></i>
                                        Detail</a>
                                        <a href="{{Route('userAdmin.pelatihan.edit','1')}}" class="btn btn-sm icon icon-left btn-primary mb-1"><i data-feather="edit"></i>
                                        Edit</a>
